    ...
    return (
      <div className="min-h-screen bg-[#f8fafc] font-montserrat pb-20">
        ...
        <div className="max-w-md mx-auto px-4 mt-16 text-center">
          <div className="bg-white p-8 rounded-2xl border border-slate-350">
            ...
            <Link
              to="/register"
              className="mt-6 inline-block w-full py-3 bg-gradient-to-r from-[#155dfc] to-[#4f39f6] text-white font-extrabold text-[12px] rounded-lg hover:scale-[1.02] transition-all no-underline"
            >
    ...
    <div className="min-h-screen bg-[#f8fafc] font-montserrat pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 mt-8">
        ...
        <div className="text-center animate-fade-in py-6">
          <div className="w-16 h-16 bg-[#10b981] rounded-full flex items-center justify-center mx-auto mb-5 -[0_6px_20px_rgba(16,185,129,0.25)]">
          ...
          <div className="mt-10 border border-slate-200 rounded-2xl overflow-hidden max-w-2xl mx-auto -[0_4px_20px_rgba(0,0,0,0.02)] bg-white">
              ...
              {registeredList.map((attendee) => (
                <div key={attendee.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-5 gap-4 text-left hover:bg-slate-50/30 transition-colors">
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 bg-gradient-to-r from-[#155dfc] to-[#4f39f6] text-white font-bold text-[12px] rounded-lg transition-all cursor-pointer border-0 flex items-center justify-center gap-1.5"
                  >
      ...
      {selectedTicket && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[999] flex items-center justify-center p-4 font-montserrat animate-fade-in print:bg-white print:p-0 print:absolute print:inset-0">
          ...
          <div className="bg-white max-w-[360px] sm:max-w-md w-full rounded-2xl border border-slate-350 overflow-hidden relative flex flex-col items-center justify-between print: print:border-none print:my-0">
