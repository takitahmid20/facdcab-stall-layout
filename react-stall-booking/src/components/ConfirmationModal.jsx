...
export default function ConfirmationModal({ data, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-[500] flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-[0_25px_50px_rgba(0,0,0,0.12)] w-full max-w-md border border-slate-200">
        ...
        <div className="p-6 flex flex-col items-center text-center gap-4">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#155dfc] to-[#4f39f6] flex items-center justify-center shadow-[0_8px_20px_rgba(21,93,252,0.3)]">
          ...
          <button
            className="w-full py-3 rounded-xl text-[13px] font-bold font-montserrat text-white bg-gradient-to-r from-[#155dfc] to-[#4f39f6] shadow-[0_4px_12px_rgba(21,93,252,0.2)] hover:shadow-[0_6px_18px_rgba(21,93,252,0.35)] hover:scale-[1.01] transition-all cursor-pointer border-0 mt-2"
            onClick={onClose}
          >
            Done
          </button>
