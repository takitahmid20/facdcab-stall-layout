    ...
    <div className="max-w-[1600px] mx-auto px-6 pt-5 pb-0">
      <div className="bg-white/85 backdrop-blur-md border border-white/60 rounded-full px-7 py-3 flex justify-between items-center shadow-[0_8px_30px_rgba(0,0,0,0.03)]">
        ...
        <div className="flex gap-3.5 items-center">
          <Link 
            to="/register" 
            className="font-montserrat text-[13.5px] font-bold bg-[#10b981] text-white px-5 py-2.5 rounded-full flex items-center gap-2 shadow-[0_4px_12px_rgba(16,185,129,0.15)] hover:scale-[1.02] hover:shadow-[0_6px_16px_rgba(16,185,129,0.25)] transition-all duration-200 no-underline"
          >
