...
export default function Navbar() {
  return (
    <div className="max-w-[1600px] mx-auto px-4 sm:px-6 pt-5 pb-0">
      <div className="bg-white/85 backdrop-blur-md border border-white/60 rounded-full px-4 sm:px-7 py-3 flex justify-between items-center -[0_8px_30px_rgba(0,0,0,0.03)]">
        ...
        <div className="flex gap-2 sm:gap-3.5 items-center">
          <Link 
            to="/register" 
            className="font-montserrat text-[11px] sm:text-[13.5px] font-bold bg-[#10b981] text-white px-3.5 py-2 sm:px-5 sm:py-2.5 rounded-full flex items-center gap-1.5 sm:gap-2 -[0_4px_12px_rgba(16,185,129,0.15)] hover:scale-[1.02] -[0_6px_16px_rgba(16,185,129,0.25)] transition-all duration-200 no-underline shrink-0"
          >
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer" 
            className="hidden sm:flex font-montserrat text-[13.5px] font-bold bg-brand-blue-grad text-white px-5 py-2.5 rounded-full items-center gap-2 -[0_4px_12px_rgba(21,93,252,0.15)] hover:scale-[1.02] -[0_6px_16px_rgba(21,93,252,0.25)] transition-all duration-200 no-underline shrink-0"
          >
