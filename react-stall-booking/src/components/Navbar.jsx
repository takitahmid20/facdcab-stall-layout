      ...
      <div className="bg-white/85 backdrop-blur-md border border-white/60 rounded-full px-7 py-3 flex justify-between items-center shadow-[0_8px_30px_rgba(0,0,0,0.03)]">
        <div className="flex items-center">
          <img 
            ...
            onClick={() => window.open('https://www.facdcab.org', '_blank')} 
          />
        </div>
        <div className="hidden md:flex gap-7 items-center">
          <a href="#" className="font-montserrat text-[13.5px] font-semibold text-slate-800 hover:text-brand-blue transition-colors duration-200 no-underline">About Us</a>
          ...
          <a href="#" className="font-montserrat text-[13.5px] font-semibold text-slate-800 hover:text-brand-blue transition-colors duration-200 no-underline">Events</a>
        ...
        <a 
          ...
          target="_blank" 
          rel="noreferrer" 
          className="font-montserrat text-[13.5px] font-bold bg-brand-blue-grad text-white px-5 py-2.5 rounded-full flex items-center gap-2 shadow-[0_4px_12px_rgba(21,93,252,0.15)] hover:scale-[1.02] hover:shadow-[0_6px_16px_rgba(21,93,252,0.25)] transition-all duration-200 no-underline"
        >
