      ...
      <div className="flex flex-col gap-4 py-5 w-full relative">
        ...
        <div className="flex flex-wrap justify-between items-center gap-6 w-full">
          <div className="flex flex-wrap gap-4 flex-1">
            <div className="bg-white/45 backdrop-blur-md border border-white/55 rounded-xl px-5 flex items-center gap-3 flex-1 min-w-[280px] h-[76px] box-border shadow-[0_8px_32px_rgba(31,38,135,0.04)]">
